...
4. **竣工阶段 (Completion & Trial)**：核心是“合法带料”。消防验收、特种设备登记、排污许可领取是开展“试生产备案”的绝对前置条件。
...
2. **跨阶段约束**：设计阶段的审查必须阻断施工阶段的开启；竣工阶段的验收必须阻断正式运营的开启。
...
{
  "status": "success",
  "message": "已按五阶段全生命周期生成行政许可逻辑图，并已独立强化反应风险评估与HAZOP的前置约束。",
  "approval_nodes": [
    ...
    // ==========================================
    {
      ...
      "type": "government_approval",
      "estimated_duration_days": 20,
      "predecessors": ["APV-301", "机电安装完工"],
      "is_hard_gate_for": ["APV-405"]
    },
    {
      "id": "APV-402",
      "phase": "竣工",
    ...
    },
    {
      ...
      "type": "government_record",
      "estimated_duration_days": 15,
      "predecessors": ["APV-401", "APV-402", "APV-403", "APV-404", "系统水联动完成"],
